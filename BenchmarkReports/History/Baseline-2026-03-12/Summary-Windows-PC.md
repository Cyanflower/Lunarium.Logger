...
The following data presents the microsecond-level performance overhead and allocation details of `Lunarium.Logger` on a desktop processor (Intel Core i7-7700) running Windows 11.
