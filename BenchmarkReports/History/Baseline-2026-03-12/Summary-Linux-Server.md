...
The following data presents the microsecond-level performance overhead and allocation details of `Lunarium.Logger` on a server-class processor (AMD EPYC 7542) running Ubuntu Linux.
