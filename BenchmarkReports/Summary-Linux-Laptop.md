...
The following data presents the microsecond-level performance overhead and allocation details of `Lunarium.Logger` on a mobile processor (Intel Core i7-8750H) running Fedora Linux.
